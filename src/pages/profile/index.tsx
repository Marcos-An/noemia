...
import ItemProfileMenu, { ProfileItemLogout } from '../../components/molecules/itemProfileMenu'
...
export default function Profile() {
  ...
  return user.uid ? <ProfileWithLogin authContext={authContext} /> : <WithoutLogin />
}
...
function ProfileWithLogin({ authContext }) {
  ...
  return (
    <div className={styles.profile}>
      ...
      <ProfileItemLogout icon="log-out" doLogout={() => doSignOut()} isLoading={authIsLoading}>Logout</ProfileItemLogout>
    </div>
  )
}