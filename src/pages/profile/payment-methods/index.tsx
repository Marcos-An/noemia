...
export default function PaymentMethod() {
  ...
  const removeItem = () => {
    ...
    deletePaymentMethod({
      ...
      const newPaymentMethods = user.paymentMethods.filter(
        (paymentMethod) => paymentMethod.number !== selectedItem.number
      );
    ...
    <div className={styles.paymentMethods}>
      ...
      <div className={styles.button}>
        <GenericButton
          text="Add a new card"
          onClick={() =>
            router.push("/profile/payment-methods/new-payment-method")
          }
        />
      </div>
      ...
      <Drawer isActive={drawerIsActive} close={() => setDrawerIsActive(false)}>
        ...
        <div className={styles.buttonUpdate}>
          ...
          <GenericInvisibleButton onClick={() => setDrawerIsActive(false)}>
            Cancel
          </GenericInvisibleButton>
        </div>
      </Drawer>
    </div>
  );
